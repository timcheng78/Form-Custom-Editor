...
export class LastUpdTimeComponent extends ListComponent {
    static dragName        = 'lastUpdTime'
    static dragDescription = '最後修改時間'
    constructor (type) {
        /** 建構式創建 */
        super('web-component', 'true', '最後修改時間', 'true', 'Y', 'lastUpdTime', type)
        /** 各類型客製化預設設置 */
